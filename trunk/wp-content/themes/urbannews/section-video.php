	...
	<ul>
		...
		<?php if ($video) { ?>
			...
			<li>
				...
				<?php } else if (!$image) {?>
					<a class="various fancybox.iframe" href="<?php echo $video; ?>"><img src="<?php echo get_template_directory_uri(); ?>/framework/images/no-imag.jpg" alt="<?php the_title(); ?>"/></a>
				<span class="play-icon"></span>
				<?php } ?>
		...
		<?php } else { ?>
			...
			<li>
				...
				<?php } else if (!$image) {?>
					<img src="<?php echo get_template_directory_uri(); ?>/framework/images/no-imag.jpg" alt="<?php the_title(); ?>"/>
				<?php } ?>
