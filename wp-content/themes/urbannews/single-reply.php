	...
	<div id="bbp-reply-wrapper-<?php bbp_reply_id(); ?>" class="bbp-reply-wrapper">
		...
		<div class="entry-content">
			...
			<table class="bbp-replies" id="topic-<?php bbp_topic_id(); ?>-replies">
				<thead>
					<tr>
						<th class="bbp-reply-author"><?php  _e( 'Автор',  'bbpress' ); ?></th>
						<th class="bbp-reply-content"><?php _e( 'Ответов', 'bbpress' ); ?></th>
					</tr>
				</thead>
				...
				<tbody>
					<tr class="bbp-reply-header">
						...
						<td class="bbp-reply-content">
							...
							<?php printf( __( 'Опубликовано %1$ на %2$', 'bbpress' ), get_the_date(), esc_attr( get_the_time() ) ); ?>
