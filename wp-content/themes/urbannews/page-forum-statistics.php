...
<?php while ( have_posts() ) : the_post(); ?>
	...
	<div id="bbp-statistics" class="bbp-statistics">
		...
		<div class="entry-content">
			...
			<?php get_the_content() ? the_content() : _e( '<p>Вот статистика и популярные темы наших форумах.</p>', 'bbpress' ); ?>

			<dl role="main">

				<?php do_action( 'bbp_before_statistics' ); ?>

				<dt><?php _e( 'Зарегистрированные пользователи', 'bbpress' ); ?></dt>
				<dd>
					<strong><?php echo $user_count; ?></strong>
				</dd>

				<dt><?php _e( 'Форумы', 'bbpress' ); ?></dt>
				<dd>
					<strong><?php echo $forum_count; ?></strong>
				</dd>

				<dt><?php _e( 'Темы', 'bbpress' ); ?></dt>
				<dd>
					<strong><?php echo $topic_count; ?></strong>
				</dd>

				<dt><?php _e( 'Ответов', 'bbpress' ); ?></dt>
				<dd>
					<strong><?php echo $reply_count; ?></strong>
				</dd>

				<dt><?php _e( 'Тэги тем', 'bbpress' ); ?></dt>
				<dd>
